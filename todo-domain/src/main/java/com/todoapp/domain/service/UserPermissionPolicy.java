 ...
 * 
 * 設計原則:
 * - Strategy Pattern: 権限チェックロジックを戦略として外部化
 * - 細粒度権限: 機能レベルでの詳細な権限制御
 * - 拡張性: 新しい権限・役割の動的追加
 */
@ThreadSafe
public final class UserPermissionPolicy {
    ...
    private void initializeDefaultPermissions() {
        // 一般ユーザー権限
        rolePermissions.put(UserRole.USER, Set.of(
        ...
        rolePermissions.put(UserRole.MODERATOR, Set.of(
                Permission.CREATE_TODO,
                Permission.READ_OWN_TODO,
                Permission.UPDATE_OWN_TODO,
                Permission.DELETE_OWN_TODO,
        ...
        // 管理者権限（モデレーター + ユーザー管理）
        rolePermissions.put(UserRole.ADMIN, Set.of(
                Permission.CREATE_TODO,
                Permission.READ_OWN_TODO,
                Permission.UPDATE_OWN_TODO,
                Permission.DELETE_OWN_TODO,
